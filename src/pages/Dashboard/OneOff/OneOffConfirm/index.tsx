...
const OneOffConfirmPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof OneoffSchema>) => {
    ...
    try {
      ...
      const res = await fetch(`${api_baseUrl}/one-off`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="size-full flex flex-col">
      <div className="flex items-center gap-3">
        ...
        <p className=" text-lg font-semibold">New one-off meeting</p>
      </div>
                    ...
                    <DialogContent className="sm:max-w-md">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="grid flex-1 gap-2">
                          ...
                          <Input
                            id="link"
                            defaultValue={`${vite_baseUrl}/d/${oneoffTitle}`}
                            readOnly
                          />
                        </div>
                        <Button
...
export default OneOffConfirmPage
